...
namespace CalamityVanilla.Content.Bosses.Cryogen.Drops;
...
public class CryogenRelic : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(ModContent.TileType<CryogenRelicTile>(), 0);
...
public class CryogenRelicTile : ModTile
{
    ...
    public virtual string RelicTextureName => "CalamityVanilla/Content/Bosses/Cryogen/Drops/CryogenRelicHologram";
