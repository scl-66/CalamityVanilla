...
using CalamityVanilla.Content.Crimson.GutOfCthulhu.Worms;
...
namespace CalamityVanilla.Content.Crimson.GutOfCthulhu;
...
internal partial class GutOfCthulhu : ModNPC
{
    ...
    public override string Texture => "CalamityVanilla/Content/Crimson/GutOfCthulhu/GutOfCthulhu_Body";
...
{
    public override string Texture => "CalamityVanilla/Content/Crimson/GutOfCthulhu/GutOfCthulhu_Eye";
