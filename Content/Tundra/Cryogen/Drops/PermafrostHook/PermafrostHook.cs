...
namespace CalamityVanilla.Content.Tundra.Cryogen.Drops.PermafrostHook;
...
public class PermafrostHookProjectile : ModProjectile
{
    ...
    {   
        if (!Main.dedServ)
            chainTexture = ModContent.Request<Texture2D>("CalamityVanilla/Content/Tundra/Cryogen/Drops/PermafrostHook/PermafrostHookChain");
