...
namespace CalamityVanilla.Content.Corruption.HiveMind.Drops;
...
public class HiveMindRelic : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(ModContent.TileType<HiveMindRelicTile>(), 0);
...
public class HiveMindRelicTile : ModTile
{
    ...
    public virtual string RelicTextureName => "CalamityVanilla/Content/Corruption/HiveMind/Drops/HiveMindRelicHologram";
