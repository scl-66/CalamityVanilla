...
namespace CalamityVanilla.Content.Corruption.HiveMind.Drops.SkinBoilHat;
...
public class SkinBoilHatDrawlayer : PlayerDrawLayer
{
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        ...
        Texture2D hatTexture = ModContent.Request<Texture2D>("CalamityVanilla/Content/Corruption/HiveMind/Drops/SkinBoilHat/SkinBoilHatEquip").Value;
